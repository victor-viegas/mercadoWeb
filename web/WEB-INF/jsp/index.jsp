                    ...
                    <div class="c-carousel__slides js-carousel--simple d-flex">
                        <div class="card rounded shadow-sm border-0">
                            <div class="card-body p-4"><img
                                    src="https://static.paodeacucar.com/img/uploads/1/120/24982120.png" alt="coca cola"
                                    class="img-fluid d-block mx-auto mb-3">
                                <h5> <a href="#" class="text-dark">Refrigerante Coca-Cola Original Garrafa 2L</a></h5>
